...
public class AdapterDaysList extends ArrayAdapter<String>{
	...
	public AdapterDaysList(Context context, String[] level, int[] food) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View rowView = inflater.inflate(R.layout.layout_dayslist,parent,false);
